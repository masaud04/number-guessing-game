...
playerTwoSubmit.addEventListener("click", function(){
    ...
    if(playerTwoInput.value === ""){
        ...
        document.getElementById("pop-up").style.transform = "translateX(-50%) scale(1)"

        pop_up.innerHTML = `wow great winner & you are win with ${attemts} Attempts`
        ...
        playerTwoError.innerHTML = playerTwoErrorText
            ...
            if(gameChance == 0){
                ...
                pop_up.innerHTML = `Sorry! Try Again Men!`

                document.getElementById("okButton").innerHTML = ` Try Again &#128530;`
